...
public class ModificarUsuarioTest {
    ...
    public void modificarUsuarioTest() {
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.username), withText("pepe"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("juan"));
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.newPassword),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("juan"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.currentPassword),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText8.perform(replaceText("pepe"), closeSoftKeyboard());

        ViewInteraction materialButton4 = onView(
                allOf(withId(R.id.bGuardar), withText("Guardar"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.nav_host_fragment_content_main),
                                        0),
                                4),
                        isDisplayed())).check(matches(withText("Guardar")));
        ...
        // Asserts para comprobar la correcta modificacion del usuario
        onView(allOf(withId(R.id.username), isDisplayed())).check(matches(withText("juan")));
